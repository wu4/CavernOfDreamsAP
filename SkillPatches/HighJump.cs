        ...
        static class Patch
        {
            static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
            {
                ...
                matcher.MatchForward(
                    true,
                    new(OpCodes.Ldarg_0),
                    CodeGenerationHelpers.LoadsField<Player>("landTimer"),
                    CodeGenerationHelpers.Calls<Timer>("GetCounter"),
                    new(OpCodes.Ldarg_0),
                    CodeGenerationHelpers.LoadsField<Player>("highJumpAfterLandingDuration"),
                    new(OpCodes.Conv_R4),
                    new(OpCodes.Bgt_Un)
                );
